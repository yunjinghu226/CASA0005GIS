# This file cleans the original census data and produces a dataframe(csv) of z-scores for each variable involved
...
# reorganize data: combine needed variables into one dataframe
