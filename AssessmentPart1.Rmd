...
#### Problem Overview and Solution Design
...
![*General Workflow*](solutionflow.png)
...
![*Detailed workflow*](processflow.png)
...
2. Q2: How many TfL station did your route pass within 100 metres distance?
...
3. Q3: How many points did you score based on treasure hunt locations they managed to get within 300 metres of?
...
4. Q4: Which Wards did you pass through that had the (a) lowest and (b) the highest rates of Male Life Expectancy?

![*Answer to Q4(a)*](Q3-1.png)


![*Answer to Q4(b)*](Q3-2.png)
...
5. Q5: What was the average life expectancy at birth for babies born in those wards along the whole route?
...
6. Q6: Is there any spatial patterns for CASA Treasure Hunt locations or are they randomly distributed?
